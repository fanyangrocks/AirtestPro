...
from airtest_pro.core.error import LocalDeviceError
...
def Logwrap(f, logger):
    ...
    def wrapper(*args, **kwargs):
        """
        The decorator @logwrap can record the function call information in the airtest_pro log and display it in the report.
