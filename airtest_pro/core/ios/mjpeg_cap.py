...
from airtest_pro.utils.snippet import reg_cleanup, on_method_ready, ready_method
from airtest_pro.core.ios.constant import ROTATION_MODE, DEFAULT_MJPEG_PORT
...
if __name__ == "__main__":
    import wda
    from AirtestPro.core.ios.instruct_cmd import InstructHelper
