...
from airtest_pro.core.win.ctypesinput import key_press, key_release
...
from airtest_pro.core.win.screen import screenshot
...
class Windows(Device):
    ...
    def touch(self, pos, **kwargs):
        ...
        Examples:
            >>> from AirtestPro.core.api import connect_device
