...
from airtest_pro.core.android.touch_methods.minitouch import Minitouch
from airtest_pro.core.android.touch_methods.maxtouch import Maxtouch
from airtest_pro.core.android.touch_methods.base_touch import BaseTouch
from airtest_pro.core.android.constant import TOUCH_METHOD
...
class TouchProxy(object):
    ...
    def auto_setup(cls, adb, default_method=None, ori_transformer=None, size_info=None, input_event=None):
        ...
        Args:
            adb: :py:mod:`airtest_pro.core.android.adb.ADB`
...
class AdbTouchImplementation(object):
    ...
    def __init__(self, base_touch):
        ...
        :param base_touch: :py:mod:`airtest_pro.core.android.adb.ADB`
        """
...
class MinitouchImplementation(AdbTouchImplementation):
    ...
    def __init__(self, minitouch, ori_transformer):
        ...
        :param minitouch: :py:mod:`airtest_pro.core.android.touch_methods.minitouch.Minitouch`
...
class MaxtouchImplementation(MinitouchImplementation):
    ...
    def __init__(self, maxtouch, ori_transformer):
        ...
        :param maxtouch: :py:mod:`airtest_pro.core.android.touch_methods.maxtouch.Maxtouch`
        :param ori_transformer: Android._touch_point_by_orientation()
        """
