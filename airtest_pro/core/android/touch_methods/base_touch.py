...
from airtest_pro.utils.snippet import (on_method_ready, ready_method, reg_cleanup, kill_proc)
...
class BaseTouch(object):
    ...
    def install_and_setup(self):
        """
        Install and setup airtest_pro touch
