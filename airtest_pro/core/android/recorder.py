...
from airtest_pro.core.android.constant import YOSEMITE_PACKAGE
from airtest_pro.core.error import AirtestError
...
from airtest_pro.utils.snippet import on_method_ready, kill_proc, reg_cleanup
