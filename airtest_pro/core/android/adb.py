...
from airtest_pro.core.android.constant import (DEFAULT_ADB_PATH, IP_PATTERN,
                                              SDK_VERISON_ANDROID7)
from airtest_pro.core.error import (AdbError, AdbShellError, AirtestError,
                                   DeviceConnectionError)
from airtest_pro.utils.compat import decode_path, raisefrom, proc_communicate_timeout, SUBPROCESS_FLAG
from airtest_pro.utils.logger import get_logger
from airtest_pro.utils.nbsp import NonBlockingStreamReader
from airtest_pro.utils.retry import retries
from airtest_pro.utils.apkparser import APK
from airtest_pro.utils.snippet import get_std_encoding, reg_cleanup, split_cmd, make_file_executable
...
class ADB(object):
    ...
    def get_adb_path():
        ...
        # Use airtest_pro builtin adb path
