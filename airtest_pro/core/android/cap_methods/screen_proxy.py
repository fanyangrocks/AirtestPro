...
from airtest_pro.core.error import AdbError, ScreenError
...
class ScreenProxy(object):
    ...
    def check_frame(cls, cap_method):
        ...
        Args:
            cap_method: :py:mod:`airtest_pro.core.android.cap_methods.base_cap.BaseCap`
    ...
    def auto_setup(cls, adb, default_method=None, *args, **kwargs):
        ...
        Args:
            ...
            default_method: String such as "MINICAP", or :py:mod:`airtest_pro.core.android.cap_methods.minicap.Minicap` object
...
def register_screen():
    ...
    from AirtestPro.core.android.cap_methods.javacap import Javacap
    from AirtestPro.core.android.cap_methods.adbcap import AdbCap
