...
from airtest_pro.core.android.constant import STFLIB
from airtest_pro.utils.logger import get_logger
from airtest_pro.utils.nbsp import NonBlockingStreamReader
from airtest_pro.utils.safesocket import SafeSocket
from airtest_pro.utils.snippet import reg_cleanup, on_method_ready, ready_method, kill_proc
from airtest_pro.utils.threadsafe import threadsafe_generator
from airtest_pro.core.android.cap_methods.base_cap import BaseCap
from airtest_pro import aircv
from airtest_pro.core.error import ScreenError
    ...
    def _get_stream(self, lazy=True):
        ...
        while not stopping:
            ...
            if self.RECVTIMEOUT is not None:
                ...
                # Set the timeout to 3s(airtest_pro>=1.2.7)
