...
from airtest_pro.utils.snippet import on_method_ready
    ...
    def _install_apk_upgrade(self, apk_path, package):
        ...
        if installed_version is None or apk_version > int(installed_version):
            ...
            try:
                ...
                warnings.warn("Yosemite.apk update failed, please try to reinstall manually(airtest_pro/core/android/static/apks/Yosemite.apk).")
