...
from airtest_pro import aircv
from airtest_pro.core.device import Device
from airtest_pro.core.android.ime import YosemiteIme
from airtest_pro.core.android.yosemite_ext import YosemiteExt
from airtest_pro.core.android.constant import CAP_METHOD, TOUCH_METHOD, IME_METHOD, ORI_METHOD, \
    SDK_VERISON_ANDROID10
from airtest_pro.core.android.adb import ADB

from airtest_pro.core.android.rotation import RotationWatcher, XYTransformer
from airtest_pro.core.android.recorder import Recorder
from airtest_pro.core.android.touch_methods.touch_proxy import TouchProxy
from airtest_pro.core.error import AdbError, AdbShellError
from airtest_pro.core.android.cap_methods.screen_proxy import ScreenProxy

# Compatible with old code
from airtest_pro.core.android.cap_methods.minicap import Minicap  # noqa
from airtest_pro.core.android.cap_methods.javacap import Javacap  # noqa
from airtest_pro.core.android.touch_methods.minitouch import Minitouch  # noqa
from airtest_pro.core.android.touch_methods.maxtouch import Maxtouch  # noqa

from airtest_pro.core.settings import Settings as ST
from airtest_pro.aircv.screen_recorder import ScreenRecorder, resize_by_max, get_max_size
from airtest_pro.utils.snippet import get_absolute_coordinate
from airtest_pro.utils.logger import get_logger
...
class Android(Device):
    ...
    def touch_proxy(self):
        ...
        Module: :py:mod:`airtest_pro.core.android.touch_methods.touch_proxy.TouchProxy`
    ...
    def touch_proxy(self, touch_method):
        ...
        Examples:
            ...
            >>> from AirtestPro.core.android.touch_methods.minitouch import Minitouch
    ...
    def touch_method(self, name):
        ...
        """
        warnings.warn("No need to manually specify touch_method, airtest_pro will automatically specify a suitable touch method, when airtest_pro>=1.1.2")
    ...
    def cap_method(self, name):
        ...
        """
        warnings.warn("No need to manually specify cap_method, airtest_pro will automatically specify a suitable screenshot method, when airtest_pro>=1.1.2")
    ...
    def get_deprecated_var(self, old_name, new_name):
        ...
        When the airtest_pro version number>=1.1.2, the call device.minicap/device.javacap is removed, and relevant compatibility is made here, and DeprecationWarning is printed
