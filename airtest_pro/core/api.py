...
from airtest_pro.core.cv import Template, loop_find, try_log_screen
from airtest_pro.core.error import TargetNotFoundError
from airtest_pro.core.settings import Settings as ST
from airtest_pro.utils.compat import script_log_dir
from airtest_pro.utils.snippet import parse_device_uri
from airtest_pro.core.helper import (G, delay_after_operation, import_device_cls,
                                    logwrap, set_logdir, using, log)
# Assertions
from airtest_pro.core.assertions import (assert_exists, assert_not_exists, assert_equal, assert_not_equal,  # noqa
    ...
    :Example:
        ...
        * ``Android``: it is equivalent to executing ``adb shell input keyevent KEYNAME`` ::
        ...
        .. seealso::
           ...
           Module :py:mod:`airtest_pro.core.android.adb.ADB.keyevent`
        ...
        * ``Windows``: Use ``pywinauto.keyboard`` module for key input::
        ...
        .. seealso::
            ...
            Module :py:mod:`airtest_pro.core.win.win.Windows.keyevent`
...
def text(text, enter=True, **kwargs):
    ...
    :Example:
        ...
        .. seealso::
            ...
            Module :py:mod:`airtest_pro.core.android.ime.YosemiteIme.code`
...
"""
Assertions: see airtest_pro/core/assertions.py
"""
